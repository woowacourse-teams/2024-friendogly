        ...
        mockMvc.perform(multipart("/clubs")
                ...
                .andDo(document("clubs/post/201",
                        ...
                        requestPartFields(
                                ...
                                fieldWithPath("city").type(JsonFieldType.STRING).description("모임의 시/군/구 주소, nullable"),
                                fieldWithPath("village").type(JsonFieldType.STRING).description("모임의 읍/면/동 주소, nullable"),
