...
public record FindClubParticipatingResponse(
        Long id,
        String title,
        String content,
    ...
    public FindClubParticipatingResponse(Club club, List<String> petImageUrls) {
        this(
                club.getId(),
                ...
                club.getStatus(), club.getCreatedAt(),
