...
VALUES (1, 37.5173316, 127.1011661, 'GOING', TIMESTAMPADD(MINUTE, -10, NOW()), FALSE),
       (2, 37.5185122, 127.098778, 'GOING', TIMESTAMPADD(MINUTE, -20, NOW()), FALSE),
       (3, 37.5191964, 127.1055562, 'GOING', TIMESTAMPADD(MINUTE, -30, NOW()), FALSE),
       (4, 37.5136533, 127.0983182, 'GOING', TIMESTAMPADD(MINUTE, -40, NOW()), FALSE),
       (5, 37.5131474, 127.1042528, 'GOING', TIMESTAMPADD(MINUTE, -50, NOW()), FALSE),
       (6, 37.5171728, 127.1047797, 'GOING', TIMESTAMPADD(MINUTE, -60, NOW()), FALSE),
       (7, 37.516183, 127.1068874, 'GOING', TIMESTAMPADD(MINUTE, -70, NOW()), FALSE);
