...
class AddressRepositoryImpl(
    ...
    override suspend fun getAddress(): Result<Address> = addressDataSource.getAddress().mapCatching { it.toDomain() }

    override suspend fun saveAddress(address: Address): Result<Unit> = addressDataSource.saveAddress(addressDto = address.toData())
}
